...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Apex SIF by ABSL — Hybrid Long Short Fund",
    description: "Review Apex Hybrid Long Short SIF by ABSL. Research-driven hybrid long-short strategy with live NAV & returns. ₹10L min investment. Compare on SIFPrime.",
  ...
  twitter: {
    title: "Apex SIF by ABSL — Hybrid Long Short Fund",
    description: "Review Apex Hybrid Long Short SIF by ABSL. Hybrid long-short strategy. ₹10L min investment. Compare on SIFPrime.",
  },
};
