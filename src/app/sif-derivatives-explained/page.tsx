...
export const metadata: Metadata = {
  ...
  description: "What derivative strategies do Indian SIFs use? Covered calls, naked shorts, straddles, pair trades, arbitrage — explained in plain English with fund-by-fund examples from all 18 SIFs.",
