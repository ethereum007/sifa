...
export const metadata: Metadata = {
  ...
  description:
    "Compare all SEBI-regulated Specialized Investment Funds (SIFs) in India. Live NAV, returns, strategy breakdown, SIF vs MF vs PMS comparison. Min \u20b910L investment. 17 SIFs tracked.",
