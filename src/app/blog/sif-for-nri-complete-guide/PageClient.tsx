          ...
          <div className="container mx-auto px-4 max-w-4xl space-y-8">
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-2 text-muted-foreground">
                ...
                <li className="flex items-start gap-3"><CheckCircle2 className="w-5 h-5 text-primary mt-0.5 shrink-0" /> <strong className="text-foreground">Edelweiss (Altiva)</strong> — Accepts NRIs; check for US/Canada restrictions</li>
                <li className="flex items-start gap-3"><CheckCircle2 className="w-5 h-5 text-primary mt-0.5 shrink-0" /> <strong className="text-foreground">ITI (Diviniti)</strong> — Accepts NRIs from most countries</li>
                <li className="flex items-start gap-3"><CheckCircle2 className="w-5 h-5 text-primary mt-0.5 shrink-0" /> <strong className="text-foreground">360 ONE (Dyna)</strong> — Accepts NRIs from most jurisdictions</li>
                <li className="flex items-start gap-3"><CheckCircle2 className="w-5 h-5 text-primary mt-0.5 shrink-0" /> <strong className="text-foreground">Tata (Titanium)</strong> — Accepts NRIs from most jurisdictions</li>
                <li className="flex items-start gap-3"><CheckCircle2 className="w-5 h-5 text-primary mt-0.5 shrink-0" /> <strong className="text-foreground">Bandhan (Arudha)</strong> — Accepts NRIs; verify specific country eligibility</li>
                <li className="flex items-start gap-3"><CheckCircle2 className="w-5 h-5 text-primary mt-0.5 shrink-0" /> <strong className="text-foreground">SBI (Magnum)</strong> — Accepts NRIs from most countries</li>
                <li className="flex items-start gap-3"><CheckCircle2 className="w-5 h-5 text-primary mt-0.5 shrink-0" /> <strong className="text-foreground">Aditya Birla Sun Life (Apex)</strong> — Accepts NRIs; check for US/Canada restrictions</li>
              </ul>
              <p className="text-base text-muted-foreground leading-relaxed">
