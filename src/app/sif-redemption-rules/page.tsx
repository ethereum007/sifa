...
export const metadata: Metadata = {
  ...
  description: "Before investing ₹10 Lakhs in a SIF, know exactly when you can get your money back. Daily redemption, interval windows, monthly exits — the complete liquidity guide for all 18 SIFs.",
  alternates: { canonical: "https://sifprime.com/sif-redemption-rules" },
  openGraph: {
    title: "SIF Redemption Rules India: Can You Exit Whenever You Want?",
    description: "Complete liquidity guide for all 18 SIFs — daily, interval, and monthly redemption windows.",
