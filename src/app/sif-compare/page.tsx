...
export const metadata: Metadata = {
  ...
  description:
    "Compare Hybrid Long-Short, Equity Long-Short and Ex-Top 100 SIFs side by side. Capital protection scores, returns, TER and strategy comparison across all 19 SIFs in India.",
  alternates: { canonical: "https://sifprime.com/sif-compare" },
  openGraph: {
    title: "Compare SIF Funds Side by Side",
    description:
      "Interactive SIF comparison tool. Alpha Shield scores, returns, costs and strategy analysis for all 19 SIFs in India.",
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            ...
            <p>
              ...
              <Link href="/all-sifs-india-ranked-explained">
                SIFPrime ranked list of all 19 SIFs
              </Link>{" "}
