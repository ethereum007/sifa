...
const Header = () => {
  ...
  const fundsItems = [
    ...
    { label: "Titanium Equity by Tata", href: "/sifs/titanium-equity-long-short" },
    ...
    { label: "Sector Rotation", href: "/sif-funds-launched", section: true },
  ...
  const learnItems = [
    ...
    { label: "All 19 SIFs Ranked & Explained", href: "/all-sifs-india-ranked-explained" },
